"""
This is a test file for the tokenizer.py module.
"""
...
class TestTokenizer(unittest.TestCase):
    ...
    def test_encode(self):
        ...
        for input_str, bos, eos, expected_output in test_cases:
            with self.subTest(input_str=input_str, bos=bos,
                              eos=eos, expected_output=expected_output):
